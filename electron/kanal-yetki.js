...
const KANAL_YETKI = Object.freeze({
  ...
  'kanal:liste': 'stok_duzenle',
  'kanal:hazirla': 'stok_duzenle',
  'kanal:uygula': 'stok_duzenle',
  'kanal:sonuc-tazele': 'stok_duzenle',
  'kanal:geri-al': 'stok_duzenle',
  'kanal:bekleyenler': 'stok_duzenle',
  'kanal:bekleyen-uygula': 'stok_duzenle',
  'kanal:bekleyen-iptal': 'stok_duzenle',
  'kanal:islemler': 'stok_duzenle',
  'kanal:islem-detay': 'stok_duzenle',
  'kanal:ana-kanal-sec': 'ayarlar_duzenle',
  'kanal:yazma-ac': 'ayarlar_duzenle',
  'kanal:acil-kapat': 'ayarlar_duzenle',
  // Trendyol sipariş tarafı. Kanal kapısı MODÜLDEKİ yetkiyle aynı olmalı, yoksa
  // kapıdan geçip modülde takılır (kafa karıştırıcı hata).
  'ty-siparis:cek': 'online_siparis_goruntule',
  'ty-siparis:listele': 'online_siparis_goruntule',
  'ty-siparis:getir': 'online_siparis_goruntule',
  'ty-siparis:sayaclar': 'online_siparis_goruntule',
  'ty-siparis:durum-listesi': 'online_siparis_goruntule',
  'ty-siparis:statu': 'kargo_yonet',
  'ty-siparis:takip-no': 'kargo_yonet',
  'ty-siparis:koli': 'kargo_yonet',
  'ty-siparis:kargo-firma': 'kargo_yonet',
  'ty-siparis:depo': 'kargo_yonet',
  'ty-siparis:sure-uzat': 'kargo_yonet',
  'ty-siparis:alternatif-teslimat': 'kargo_yonet',
  'ty-siparis:manuel-teslim': 'kargo_yonet',
  'ty-siparis:tedarik-edilemedi': 'kargo_iptal',
  'ty-siparis:manuel-iade': 'kargo_iptal',
  'ty-iade:listele': 'online_siparis_goruntule',
  'ty-iade:red-sebepleri': 'online_siparis_goruntule',
  'ty-iade:gecmis': 'online_siparis_goruntule',
  ...
  'ty-finans:mutabakat': 'rapor_goruntule',
  'ty-finans:diger': 'rapor_goruntule',
  'ty-finans:kargo-fatura': 'rapor_goruntule',
  'ty-tazmin:listele': 'rapor_goruntule',
