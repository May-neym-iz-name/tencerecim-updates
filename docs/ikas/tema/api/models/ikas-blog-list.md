<!-- kaynak: https://ikas.dev/docs/theme/api/models/ikas-blog-list -->

# IkasBlogList

`data`IkasBlog[]

Refer to the IkasBlog reference.
...
```typescript
function toJSON(): { data: IkasBlog[]; type: IkasBlogListType; limit: number; page: number; count: number; initialized: boolean; minPage: number | null | undefined; blogListPropValue: IkasBlogListPropValue; filterCategoryId: string | null;}
```
Copy
