<!-- kaynak: https://ikas.dev/docs/theme/api/models/ikas-customer-review-list -->
...
```typescript
function toJSON(): { data: IkasCustomerReview[]; limit: number; page: number; count: number; initialized: boolean; minPage: number | null | undefined; productId: string;}
```
Copy
