...
export const kanalApi = {
  ...
  bekleyenler: () => invoke('kanal:bekleyenler'),
  bekleyenUygula: (islem_id) => invoke('kanal:bekleyen-uygula', { islem_id }),
  bekleyenIptal: (islem_id) => invoke('kanal:bekleyen-iptal', { islem_id }),
